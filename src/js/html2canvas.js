...
(function (global, factory) {
    ...
    ***************************************************************************** */
        ...
        Trie.prototype.get = function (codePoint) {
            ...
            if (codePoint >= 0) {
                ...
                if (codePoint < this.highStart) {
                    ...
                    ix = this.index[ix];
                    ix +=
                        (codePoint >> UTRIE2_SHIFT_2$1) & UTRIE2_INDEX_2_MASK$1;
                    ix = this.index[ix];
                    ix =
                        (ix << UTRIE2_INDEX_SHIFT$1) +
                        (codePoint & UTRIE2_DATA_MASK$1);
    ...
    var pack = function (r, g, b, a) {
        return (
            ((r << 24) | (g << 16) | (b << 8) | (Math.round(a * 255) << 0)) >>>
            0
        );
    };
        ...
        parseFunctionArgs(tokens).forEach(function (arg, i) {
            if (i === 0) {
                ...
                if (
                    ...
                    angle$1 =
                        (angle.parse(context, firstToken) + deg(270)) %
                        deg(360);
                    return;
                }
            }
        ...
        Trie.prototype.get = function (codePoint) {
            ...
            if (codePoint >= 0) {
                if (
                    ...
                    ix =
                        (ix << UTRIE2_INDEX_SHIFT) +
                        (codePoint & UTRIE2_DATA_MASK);
                    return this.data[ix];
                }
                if (codePoint <= 0xffff) {
                    // Lead Surrogate Code Point.  A Separate index section is stored for
            ...
            try {
                if (
                    ...
                    var bodyBackgroundColor = iframe.contentWindow.document.body
                        ...
                        : COLORS.TRANSPARENT;
                    _this.backgroundColor = isTransparent(
        ...
        function ElementPaint(container, parent) {
            ...
            if (this.container.styles.overflowX !== 0 /* VISIBLE */) {
                ...
                if (equalPath(borderBox, paddingBox)) {
                    ...
                    this.effects.push(
                        new ClipEffect(paddingBox, 4 /* CONTENT */)
                    );
                }
            }
        }
                            ...
                            if (
                                !(
                                    container instanceof
                                        IFrameElementContainer && container.tree
                                )
                            )
                                return [3 /*break*/, 14];
            ...
            return __generator(this, function (_u) {
                switch (_u.label) {
                    case 0:
                        ...
                        windowOptions = {
                            windowWidth:
                                (_f = opts.windowWidth) !== null &&
                                _f !== void 0
                                    ? _f
                                    : defaultView.innerWidth,
                            windowHeight:
                                (_g = opts.windowHeight) !== null &&
                                _g !== void 0
                                    ? _g
                    ...
                    case 1:
                        ...
                        renderOptions = {
                            ...
                            scale:
                                (_o =
                                    ...
                                    : 1,
                            x:
                                ((_p = opts.x) !== null && _p !== void 0
                                    ? _p
                                    : 0) + left,
                            y:
                                ((_q = opts.y) !== null && _q !== void 0
                                    ? _q
                                    : 0) + top,
                            width:
                        ...
                        renderer = new ForeignObjectRenderer(
                            context,
                            renderOptions
                        );
